...
import { computeProgress } from "./lib/computeProgress";
import { DSASheet } from "./types";
import DSACard from "./_components/DSACard";
import { motion, AnimatePresence } from "framer-motion";
import { Bookmark, Search, Tag, X } from "lucide-react";
import DSASheetExploreSkeleton from "./_components/Dsasheetexploreskeleton";
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 py-12 mt-8">
        ...
        {activeFilter === "saved" && finalSheets.length === 0 && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex flex-col items-center justify-center gap-2 py-20 text-[var(--bg-active)]"
          >
