...
function InlineBubbleMenu({ editor }: { editor: ReturnType<typeof useEditor> }) {
  ...
  return (
    <div
      ref={ref}
      className="absolute z-50 flex items-center gap-0.5 bg-[var(--bg-elevated)] border border-[var(--border-medium)] rounded-lg px-2 py-1.5 shadow-2xl pointer-events-auto"
    ...
    >
      ...
      <button
        ...
        className="p-1.5 rounded-md text-[var(--text-faint)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-hover)] transition-all"
      >
    ...
    editorProps: {
      attributes: {
        class: [
          ...
          // Paragraph
          "[&_p]:my-1.5 [&_p]:text-[var(--text-secondary)] [&_p]:leading-7",
          // Lists
          ...
          "[&_pre_code]:bg-transparent [&_pre_code]:text-[var(--text-faint)] [&_pre_code]:p-0 [&_pre_code]:text-xs",
          // Links
          "[&_a]:text-[#3A5EFF] [&_a]:no-underline [&_a]:hover:underline",
          // Images
          "[&_img]:rounded-lg [&_img]:max-w-full [&_img]:my-4 [&_img]:border [&_img]:border-[var(--border-subtle)]",
          // Table
          "[&_table]:border-collapse [&_table]:w-full [&_table]:my-4",
          "[&_td]:border [&_td]:border-[var(--border-subtle)] [&_td]:px-3 [&_td]:py-2 [&_td]:text-sm [&_td]:text-[var(--text-secondary)] [&_td]:align-top",
          ...
          // Placeholder
          "[&_.is-editor-empty:first-child::before]:text-[var(--text-disabled)]",
          "[&_.is-editor-empty:first-child::before]:content-[attr(data-placeholder)]",
          "[&_.is-editor-empty:first-child::before]:float-left",
          "[&_.is-editor-empty:first-child::before]:pointer-events-none",
          "[&_.is-editor-empty:first-child::before]:h-0",
          "[&_.is-empty::before]:text-[var(--text-disabled)]",
